...
export const reviewRun = sqliteTable(
  "review_run",
  {
    ...
    sandboxStartedAt: integer("sandbox_started_at", { mode: "timestamp_ms" }),
    sandboxCompletedAt: integer("sandbox_completed_at", { mode: "timestamp_ms" }),
  ...
  (table) => [
    ...
    index("review_run_sandboxId_idx").on(table.sandboxId),
